...
public class ActivitiTest {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ac = new ClassPathXmlApplicationContext(new String[] { "db-spring.xml", "activiti-spring.xml" });
		...
		if (null != historicProcessInstanceList && 0 != historicProcessInstanceList.size()) {
			for (HistoricProcessInstance hisInstance : historicProcessInstanceList) {
				System.out.println("历史流程, id = " + hisInstance.getId() + ", end time = " + hisInstance.getEndTime());
			}
		}
	}
}
